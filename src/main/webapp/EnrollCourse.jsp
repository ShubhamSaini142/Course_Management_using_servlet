...
<body>
	<div class="container">
		...
		<form action="courseEnroll">
			<label>Enter the CourseID to Enroll</label> <input type="number"
				name="cid"> <label>Enter Your Id to Enroll</label> <input
				type="number" name="sid"> <br>
			<h1>
				<input type="submit">
			</h1>
		</form>
		...
		<br> <a href="studentHome.jsp">Go To Home</a>
	</div>
</body>
</html>
