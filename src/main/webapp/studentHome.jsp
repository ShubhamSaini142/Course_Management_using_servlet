...
<body id="page-top">
	...
	%>
			...
			<div class="row gx-4 gx-lg-5 justify-content-center">
				...
				<div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
					<a href="Assignment1"> <span
						class="service-icon rounded-circle mx-auto mb-3"><i
							class="icon-pencil"></i></span>
					</a>
					<h4>
						<strong>View score of assignment1</strong>
					</h4>
					<!-- <p class="text-faded mb-0">Freshly redesigned for Bootstrap 5.</p> -->
				</div>

				<div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
					<a href="Assignment2"> <span
						class="service-icon rounded-circle mx-auto mb-3"><i
							class="icon-pencil"></i></span>
					</a>
					<h4>
						<strong>View score of assignment2</strong>
					</h4>
					<!-- <p class="text-faded mb-0">Freshly redesigned for Bootstrap 5.</p> -->
				</div>

				<div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
					<a href="ScoreCard.jsp"> <span
						class="service-icon rounded-circle mx-auto mb-3"><i
							class="icon-screen-smartphone"></i></span>
					</a>
					<h4>
						<strong>View Score Cards</strong>
					</h4>
					<!-- <p class="text-faded mb-0">Freshly redesigned for Bootstrap 5.</p> -->
				</div>

				<div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
					<a href="LogoutController"> <span
						class="service-icon rounded-circle mx-auto mb-3"><i
	...
	<footer class="footer text-center">
		<div class="container px-4 px-lg-5">
			...
			<p class="text-muted small mb-0">Copyright &copy; Course
				Management Portal 2023</p>
		</div>
</body>
</html>